...
public class LibraryControllerTest {
    ...
    void setUp() {
        ...
        ambatolampyLibrary = new Library(
                UUID.randomUUID(),
                "Ambatolampy Library",
                "Ambatolampy 104",
                "0380000002",
    ...
    void getById_shouldReturn200_when_Library_exists() throws Exception {
        ...
        when(libraryService.getById(existingUUID))
                .thenReturn(response);

        mockMvc.perform(get("/libraries/" + existingUUID))
    ...
    void getById_shouldReturn404_when_library_doesNotExist() throws Exception {
        ...
        when(libraryService.getById(randomUUID))
                .thenThrow(new LibraryNotFoundException(randomUUID));

        mockMvc.perform(get("/libraries/" + randomUUID))
                .andExpect(status().isNotFound());
    }

    @Test
    void getById_shouldReturn400_when_IdIsNotValid() throws Exception {
        mockMvc.perform(get("/libraries/123"))
